...
const InvestingNews = () => {
  ...
  const investingNews = news.filter((news) => news.priority === "none");

  return (
    <div className="px-4 md:px-8 mt-20">
      <HeroSection news={investingNews[0]} />
      <HightlightCard allNews={investingNews} />
      <ArticaleCard allNews={investingNews} />
