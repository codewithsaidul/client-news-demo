...
const PropertyNews = () => {
  ...
  const propertyNews = news.filter((news) => news.priority === "none"  && news.status === "published");

  return (
    <div>
      {propertyNews.length > 0 ? (
        <div className="px-4 md:px-8 mt-20">
          <HeroSection news={propertyNews[0]} />
          <HightlightCard allNews={propertyNews} />
          <ArticaleCard allNews={propertyNews} />
